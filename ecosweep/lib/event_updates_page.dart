...
class _EventUpdatesPageState extends State<EventUpdatesPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _uploadImage() async {
    ...
    try {
      ...
      final String storagePath = 'event_photos/${widget.event['id']}/$timestamp';
      ...
      child: Column(
        children: [
          _buildGuidelineCard(
            ...
            content: 'Event Time: ${widget.event['date']}\nDuration: 3 hours\nRegistration: 30 minutes before start',
          ),
          _buildGuidelineCard(
            icon: Icons.inventory_2,
            title: 'What to Bring',
            content: '• Comfortable clothes\n• Water bottle\n• Hat & sunscreen\n• Work gloves\n• Face mask',
          ),
          _buildGuidelineCard(
            icon: Icons.medical_services,
            title: 'Safety Guidelines',
            content: '• Follow safety instructions\n• Stay hydrated\n• Use provided equipment properly\n• Report any incidents',
          ),
          _buildGuidelineCard(
            icon: Icons.people,
            title: 'Team Protocol',
            content: '• Work in assigned groups\n• Maintain communication\n• Support team members\n• Follow leader instructions',
          ),
        ],
      ),
    );
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildMessageBubble(doc.data() as Map<String, dynamic>);
                },
              );
            },
          ),
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              return GridView.builder(
                ...
                itemCount: snapshot.data!.docs.length,
                itemBuilder: (context, index) {
                  var photo = snapshot.data!.docs[index].data() as Map<String, dynamic>;
            ...
            Row(
              children: [
                CircleAvatar(
                  ...
                  radius: 16,
                  child: Text(
                    (feedback['userName'] ?? 'A')[0].toUpperCase(),
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                    ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (feedback['timestamp'] != null)
                        Text(
                          formatTimestamp(feedback['timestamp'] as Timestamp),
                          style: TextStyle(
                            color: Colors.grey,
                            fontSize: 12,
                          ),
